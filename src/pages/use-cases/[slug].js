  ...
  return (
    <>
      <SeoFields
        ...
        canonical={`${seoConfigData?.canonicalUrl}/use-cases/${blogData.slug}`}
      />
      <PageSectionWrapper
        fields={{
...
export async function getStaticPaths() {
  ...
  return {
    paths: items.map((blogPage) => {
      return { params: { slug: blogPage?.slug }, locale: "en" };
    }),
    fallback: "blocking",
  };
}
